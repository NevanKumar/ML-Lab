...
# 1. Initial Gradient Boosting Training
print("Initial Gradient Boosting Training:")
initial_accuracy = train_evaluate_gb(X_train, X_test, y_train, y_test)
...
train_evaluate_gb(X_train_l1, X_test_l1, y_train, y_test)
...
train_evaluate_gb(X_train_l2, X_test_l2, y_train, y_test)
...
train_evaluate_gb(X_train_scaled, X_test_scaled, y_train, y_test)
